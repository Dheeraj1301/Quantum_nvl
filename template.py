...
PROJECT_STRUCTURE = {
    ...
    "modules": {
        ...
        "q_energy": ["__init__.py", "qbm_scheduler.py", "classical_scheduler.py"],
        "q_compression": ["__init__.py", "q_autoencoder.py", "classical_compressor.py"],
        "q_decompression": ["__init__.py", "qft_decoder.py", "hhl_solver.py"],
        "q_hpo": ["__init__.py", "vqc_optimizer.py", "classical_search.py"],
        "q_nvlinkopt": ["__init__.py", "q_graph_optimizer.py", "classical_router.py"],
        "q_attention": ["__init__.py", "quantum_attention.py", "classical_attention.py"],
    ...
    "core": ["__init__.py", "quantum_backend.py", "classical_fallback.py", "pipeline_manager.py", "config.py", "logger.py"],
    ...
    "tests": ["test_routing.py", "test_energy.py", "test_compression.py"]
}
